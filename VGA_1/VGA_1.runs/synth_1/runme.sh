...
HD_PWD='E:/B. Tech II Year/II Semester/EC_252/FPGA week 1/FPGA_Projects/VGA_1/VGA_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_1.tcl
