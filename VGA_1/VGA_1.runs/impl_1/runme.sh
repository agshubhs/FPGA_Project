...
HD_PWD='E:/B. Tech II Year/II Semester/EC_252/FPGA week 1/FPGA_Projects/VGA_1/VGA_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_1.tcl -notrace
