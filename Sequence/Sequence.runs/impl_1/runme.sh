...
HD_PWD='E:/B. Tech II Year/II Semester/EC_252/FPGA week 1/FPGA_Projects/Sequence/Sequence.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sequence.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sequence.tcl -notrace
