...
HD_PWD='E:/B. Tech II Year/II Semester/EC_252/FPGA week 1/FPGA_Projects/Sequence/Sequence.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sequence.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sequence.tcl
